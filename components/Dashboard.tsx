...
const STATUS_CONFIG = {
  unverified: {
    label: "미인증",
    description:
      "약사 인증이 필요합니다. 인증을 완료해야 거래 기능을 이용할 수 있습니다.",
  ...
  verified: {
    label: "인증 완료",
    description:
      "약사 인증이 완료되었습니다. 모든 거래 기능을 자유롭게 이용하실 수 있습니다.",
  ...
  rejected: {
    label: "인증 반려",
    description:
      "약사 인증이 반려되었습니다. 서류를 확인 후 다시 제출해주세요.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-sky-50/30 to-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 page-enter">
        ...
        {status !== "verified" && (
          <div
            className={`rounded-2xl border p-6 flex items-start gap-4 mb-8 ${config.color}`}
          >
